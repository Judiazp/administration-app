...
const Transaction = (props) => {
    ...
    const update = (event) => {
        ...
        updateRecord(editData.description, editData.amount)
    }
    ...
    return (
        <div >
            <div className="transaction" style= { style }>
                ...
                <button className = 'btn' title = "Editar" onClick = { formDisplay }>
            ...
            <form className = "formEdit form" onSubmit = { update } >
                <input className = "input" type = "text" placeholder = "Editar monto" onChange = { onChange } />
                <textarea className = "input" type = "text" placeholder = "Editar descripción" onChange = { onChange } />
            </form>
        </div>
    )
}
